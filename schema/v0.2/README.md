...
- `meeting-output.schema.json` — the schema itself
...
Draft. Field names and structure may change before `v1.0.0`. From `v1.0.0` onward, the schema commits to a 3-year no-breaking-changes window.

See [../../SPEC.md](../../SPEC.md) for the full specification text, including conformance language and rationale.